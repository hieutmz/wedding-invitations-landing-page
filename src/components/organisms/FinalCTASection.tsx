...
export default function FinalCTASection() {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-[#9A5030] via-[#B86848] to-[#D08C6A] relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-10 left-[10%] w-32 h-32 rounded-full bg-white/10 blur-2xl" />
        <div className="absolute bottom-10 right-[10%] w-48 h-48 rounded-full bg-[#E3DCCE]/15 blur-2xl" />
      </div>
