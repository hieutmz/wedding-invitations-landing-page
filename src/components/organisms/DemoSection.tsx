...
export default function DemoSection() {
  return (
    <section id="demo" className="py-20 bg-gradient-to-br from-cream-50 to-blush-50 dark:from-[#1C1917] dark:to-[#26211E]">
      <Container maxWidth="lg">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Typography variant="h2" className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-[#F5EDE5]">
              Trải nghiệm thiệp cưới online
            </Typography>
            <Typography variant="body1" className="text-gray-600 dark:text-[#C4AFA8] mb-6 text-lg leading-relaxed">
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={feature} className="flex items-center gap-3 text-gray-700 dark:text-[#C4AFA8]">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-rose-100 to-blush-100 aspect-[4/3] shadow-2xl">
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-rose-200/50 to-cream-200/50">
                <div className="text-center">
                  ...
                  <Typography variant="body1" className="text-gray-600 dark:text-[#C4AFA8] mt-3 font-medium">
                    Nhấn để xem demo
                  </Typography>
                </div>
              </div>
              ...
              {/* Phone mockup frame */}
              <div className="absolute top-4 right-4 bg-white/80 dark:bg-[#2A2520]/80 backdrop-blur-sm rounded-xl p-3 shadow-lg">
