...
export default function OurStorySection() {
  ...
  return (
    <section id="our-story" className="py-24 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-cream-50 via-white to-cream-50 dark:from-[#1C1917] dark:via-[#1C1917] dark:to-[#1C1917]" />
      <div className="absolute top-32 right-[5%] w-72 h-72 bg-blush-50 dark:bg-[#26211E] rounded-full opacity-40 blur-3xl" />
      ...
      <Container maxWidth="lg" className="relative z-10">
        ...
        <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="max-w-3xl mx-auto mb-16">
          <div className="bg-white dark:bg-[#2A2520] rounded-3xl p-8 md:p-10 shadow-sm border border-gray-100/80 dark:border-white/10">
            <Typography variant="body1" className="text-gray-700 dark:text-[#C4AFA8] text-lg md:text-xl leading-relaxed whitespace-pre-line text-center">
              {opening}
            </Typography>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 max-w-4xl mx-auto mb-16">
          <motion.div variants={fadeInLeft} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
            <div className="h-full bg-cream-50 dark:bg-[#26211E] rounded-3xl p-8 border border-cream-200 dark:border-white/10">
              ...
              <Typography variant="body1" className="text-gray-700 dark:text-[#C4AFA8] text-base md:text-lg leading-relaxed whitespace-pre-line">{turning}</Typography>
            </div>
          </motion.div>
          <motion.div variants={fadeInRight} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
            <div className="h-full bg-blush-50 dark:bg-[#2A2520] rounded-3xl p-8 border border-blush-100 dark:border-white/10">
              ...
              <Typography variant="body1" className="text-gray-700 dark:text-[#C4AFA8] text-base md:text-lg leading-relaxed whitespace-pre-line">{idea}</Typography>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="max-w-3xl mx-auto mb-16">
          <div className="flex gap-6">
            ...
            <div className="space-y-8 flex-1">
              <div className="bg-white dark:bg-[#2A2520] rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100/80 dark:border-white/10">
                <Typography variant="body1" className="text-gray-700 dark:text-[#C4AFA8] text-base md:text-lg leading-relaxed whitespace-pre-line">{journey}</Typography>
              </div>
              <div className="bg-white dark:bg-[#2A2520] rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100/80 dark:border-white/10">
                <Typography variant="body1" className="text-gray-700 dark:text-[#C4AFA8] text-base md:text-lg leading-relaxed whitespace-pre-line">{motivation}</Typography>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="max-w-3xl mx-auto mb-16">
          <div className="bg-gradient-to-r from-cream-50 via-blush-50 to-cream-50 dark:from-[#26211E] dark:via-[#2A2520] dark:to-[#26211E] rounded-3xl p-8 md:p-10 border border-rose-100/60 dark:border-white/10">
        ...
        <motion.div variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="text-center max-w-xl mx-auto">
          ...
          <Typography variant="h5" className="font-heading text-gray-800 dark:text-[#F5EDE5] leading-relaxed whitespace-pre-line italic">{closing}</Typography>
